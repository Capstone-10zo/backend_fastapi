...
model6 = load_model("model/model-blepharoncus(안검염).h5")
model7 = load_model("model/model-corneal_ulcer(궤양성각막질환).h5")
model8 = load_model("model/model-noncorneal_ulcer(비궤양성각막질환).h5")
model9 = load_model("model/model-eye_cancer(안검종양v1).h5")
model10 = load_model("model/model-pigmentary_keratitis(색소침착성각막염).h5")
